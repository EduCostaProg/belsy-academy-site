        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 font-normal text-white/70">
              <li>
                <a
                  href="https://wa.me/553799350989"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 py-1.5 transition hover:text-belsy-green"
                >
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex py-1.5 transition hover:text-belsy-green"
                >
                  Instagram →
                </a>
              </li>
